  ...
  return (
    <div className="w-full h-full bg-zinc-950 text-zinc-100 font-mono select-none flex flex-col p-4 justify-between rounded-none">
      ...
      <div className="grid grid-cols-4 gap-2 flex-1">
        <button
          onClick={handleClear}
          className={`py-3.5 rounded-xl text-xs font-bold transition-all active:scale-95 ${activeKey === 'Escape' ? 'ring-2 ring-rose-500' : ''
        ...
        <button
          ...
          className={`py-3.5 rounded-xl flex items-center justify-center transition-all active:scale-95 ${activeKey === 'Backspace' ? 'ring-2 ring-zinc-400' : ''
        ...
        <button
          onClick={() => handleOp('÷')}
          className={`py-3.5 rounded-xl flex items-center justify-center transition-all active:scale-95 ${activeKey === '/' ? 'ring-2 ring-purple-400' : ''
        ...
        {['7', '8', '9'].map((num) => (
          <button
            ...
            className={`py-3.5 rounded-xl text-base font-semibold transition-all active:scale-95 ${activeKey === num ? 'ring-2 ring-purple-400' : ''
        ...
        <button
          ...
          className={`py-3.5 rounded-xl text-base font-semibold transition-all active:scale-95 ${activeKey === '0' ? 'ring-2 ring-purple-400' : ''
            } bg-zinc-800/40 hover:bg-zinc-800 text-zinc-100 border border-zinc-800`}
        >
          0
        </button>
        ...
        <button
          onClick={() => handleDigit('.')}
          className={`py-3.5 rounded-xl text-base font-semibold transition-all active:scale-95 ${activeKey === '.' ? 'ring-2 ring-purple-400' : ''
            } bg-zinc-800/40 hover:bg-zinc-800 text-zinc-100 border border-zinc-800`}
        >
          .
        </button>
        ...
        <button
          ...
          className={`py-3.5 rounded-xl flex items-center justify-center transition-all active:scale-95 ${activeKey === '=' ? 'ring-2 ring-purple-200' : ''
